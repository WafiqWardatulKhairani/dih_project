<nav class="bg-white shadow-sm sticky top-0 z-50">
    <div class="container mx-auto px-4 py-3 flex justify-between items-center">
        <div class="flex items-center">
            ...
            <img src="{{ asset('images/logo.png') }}" alt="Logo GovInnovate" class="h-12 md:h-20">
        </div>
        ...
        <div class="hidden md:flex items-center space-x-8">
            ...
            <div class="flex space-x-3">
                <a href="#" class="px-4 py-2 text-sm font-medium rounded-lg border border-blue-600 text-blue-600 hover:bg-blue-50 transition-colors">Masuk</a>
                <a href="#" class="px-4 py-2 text-sm font-medium rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition-colors">Daftar</a>
            </div>
        </div>
