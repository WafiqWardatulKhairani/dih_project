    ...
    <div class="container mx-auto px-6 py-4">
        <div class="flex justify-between items-center">
            <div class="flex items-center">
                <img src="https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/e59995a1-e623-4a1c-842d-5ea0e8feb790.png" alt="Logo Innovation Hub dengan desain modern dan fresh" class="h-14 w-14 mr-4">
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">Innovation Hub</h1>
                    <p class="text-sm text-gray-600">Kolaborasi Pemerintah & Akademisi</p>
                </div>
            </div>
            ...
            <div class="flex items-center space-x-4">
                <button onclick="openProgramModal()" class="btn-secondary hidden md:flex">
                    <i class="fas fa-plus-circle mr-2"></i>Post Program
                </button>
